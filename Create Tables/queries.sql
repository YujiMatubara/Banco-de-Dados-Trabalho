...
SELECT DISTINCT EMAILS.ID, EMAILS.EMAIL, NIVEL, PC.ORDEM, COUNT(C.NOME)
...
GROUP BY EMAILS.ID, EMAILS.EMAIL, NIVEL, PC.ORDEM
ORDER BY PC.ORDEM DESC, COUNT(C.NOME) DESC;
